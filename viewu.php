 ...
 <nav class="navbar navbar-fixed-top">
  <div class="container-fluid">
    ...
    <?php
        include_once("connection.php");
             ...
             $sql = "SELECT S.firstname,S.lastname,S.image,S.username FROM signup S WHERE S.username NOT IN (
  SELECT T.username
  FROM signup T
  WHERE T.username='$use')";
    ...
    ?></td>  
              ...
              <td><?php echo $res['firstname']," ",$res['lastname'];?>
               </td>
               <td><a href="editpost.php?view=1&username=<?php echo $res['username']; ?>">View</a></td>
